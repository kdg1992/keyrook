...
| --- | --- |
| Core and desktop tests on Windows, Linux and macOS, including format, cryptography, settings parsing, clipboard ownership logic, inactivity deadline and update-response validation | Installing the unsigned MSI, DMG, DEB and RPM interactively, including SmartScreen and Gatekeeper steps, menu entries and shortcuts |
